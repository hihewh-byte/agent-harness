...
T1_SUPPLEMENT = """以下是我的补剂方案：时间 项目 具体内容 核心逻辑 上午 训练后（结束30分钟内） 训练后恢复 蛋白粉30g + 2根香蕉 + 5g肌酸 + B族（周2-3次） + 益生菌 快速补充糖原、肌肉蛋白合成、动力恢复 上午 10:30 抗炎组合 槲皮素 + 菠萝蛋白酶（2粒） 减轻训练炎症、增强血管弹性（可与训练后餐同服） 中午 12:30（午餐时） 脂溶性营养 + 药物 鱼油 + 卵磷脂 + D3+K2 + 蓝莓 + 200mg Q10 + 药物项C + 药物项A 随油脂吸收最好，固定药物项A时间 晚上 19:00（晚餐） 晚餐主餐 300-400g 烤红薯（或等量复合碳水） + 蛋白 + 蔬菜 + Move Free（氨糖） + 姜黄素（可选） 稳定夜间血糖、降低凌晨皮质醇峰值、关节保护 睡前 30-60分钟（22:00前） 睡眠 & 心血管支持 镁 300-400mg（甘氨酸镁） 纳豆激酶（建议2000-4000 FU） 1根香蕉（可选，轻碳水） 南非醉茄（Ashwagandha，可选） 压低皮质醇、放松神经、改善早醒 + 夜间心血管保护"""

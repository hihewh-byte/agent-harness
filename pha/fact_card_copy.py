...
_EN: dict[str, str] = {
    ...
    "bg_brief_lead": "The following is self-reported supplement, medication, lifestyle, and symptom context from your chats. Use it only to shape cautions and wording. Do not cite it as data, do not restate or give doses, and ignore anything unrelated to today's card.",
    ...
    "empty_metrics": "No metrics selected",
    "latest": "{day}, latest",
    "until": "as of {hm}",
    "hk_ok": "Latest HealthKit sample row: {metric} @ {at}. Data in the Health app is not on this Mac until you run PHA Sync Health / Sleep.",
    ...
    "advice_partial": "{label}{until}cumulative, in progress, no band.",
...
_ZH: dict[str, str] = {
    ...
    "bg_brief_lead": "以下为用户在对话中自述的补剂、用药、生活习惯与症状，仅用于调整建议的措辞与注意事项。不得引用为数值，不得复述或给出剂量，与今日卡片无关则忽略。",
    ...
    "latest": "{day}，最近一次",
    "until": "截至 {hm}",
    "hk_ok": "最近一次 HealthKit 样本行：{metric} @ {at}。健康 App 有数不等于已进 Mac；请跑「PHA 同步健康 / 睡眠」。",
    ...
    "advice_partial": "{label}{until}累计，进行中，不分档。",

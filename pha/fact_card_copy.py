...
_EN: dict[str, str] = {
    ...
    "loop_lead": "Unrecognized nicknames from recent chat show up here. Approve applies them on this Mac only (data/loop_local_aliases.json) — repo catalog unchanged. Reject dismisses this item.",
...
_ZH: dict[str, str] = {
    ...
    "loop_h2": "Loop 审批（运维）",
    "loop_lead": "最近对话里尚未识别的叫法会出现在这里。同意后只写入本机 data/loop_local_aliases.json，本机对话立刻可用；不改仓库 catalog。拒绝即关闭本条。",

...
3. **经典追溯契约**：本系统引入 `RECALL_FOCUS` 贴底槽位设计与 Active Recall 机制，其合法性完全源自于：真机多轮对话 R3 轮次中，11B 本地模型由于长上下文噪声污染导致“忘了第 1 轮定账事实、对齐药物项A药物开始胡说”的真实 Attention 衰减日志。所有功能必须“见字定账，因痛起案”。

...
**验收句（第三轮 golden）**：回答中 **必须** 出现「历史 LDL 改善与药物项A/已有管理相关」类表述，**不得** 写「指标变化不足以证明槲皮素疗效」却不点明药物项A。
...
| 【依据】[用药] 药物项A →【推论】… | 您档案里一直在用药物项A，且 LDL 已到 2.45，说明降脂管理本身有效… |
...
| E3 | 轮3 降血脂+本品 | lipid_bridge 或 attachment_*；引用 LDL **且** 区分药物项A历史 vs 新品；**无** 三步看诊标题 |

...
| **M1-P7** | **递进个人基线 + 通用参考层**（无 LLM） | `TODO` | 依据：Mac 库 `default` 有睡眠 642 夜 / HRV 1936 天 / RHR 2255 天，但 90 日窗口只剩 0–1 天（zip 止于 2026-06-09），卡误报「基线不足」。做：FR-2.1 / FR-2.6 递进窗口 + 窗口披露；FR-2.8 注册表 `reference_range` + T1 披露句；卡级综合三档；selfcheck。**先做这张**，让卡立刻有内容 |
